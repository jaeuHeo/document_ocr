...
# MEDIA_URL = 'save_fig/' # 항상 / 로 끝나도록 설정
#
# MEDIA_ROOT = os.path.join('machine_learning_app/csv/save_fig')

ROOT_PATH = '/'.join(BASE_DIR.split('/')[:-1])
DRAW_IMG_PATH = os.path.join(ROOT_PATH, 'draw_poly_img/')
# print(MEDIA_PATH)
MEDIA_PATH = os.path.join(ROOT_PATH, 'img/')
# print(MEDIA_PATH)
# MEDIA_PATH =  '/doc_classifier/img/'
MEDIA_ROOT = MEDIA_PATH
MEDIA_URL = '/doc_classifier/static/'
