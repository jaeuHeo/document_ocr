...
class api_model():
            ...
            if info[0]['p1'] != [0, 0] and info[0]['p3'] != [0, 0]:
                ...
                for idx2, k in enumerate(results[0].values.tolist()):
                    ...
                    if acc_cer2 > 0.9:
                        ...
                        if idx1 != 0:
                            append_list = [[text, info[0], info[1]], [text2, test_kbox]]
    ...
    def model(self,test_img_cp,results,num_test=0):
        ...
        for regist, test in arr_ocr:
            ...
            point_rec_box = [
                [(test[1][0] / self.test_sh[1] + (regist[1]['p1'][0] - regist[2]['p1'][0]) / self.regist_sh[1]) * self.test_sh[1] - (regist_h / 2 * self.test_sh[0]),
                 (test[1][1] / self.test_sh[0] - regist_h / 4) * self.test_sh[0]],

                [(test[1][2] / self.test_sh[1] + (regist[1]['p2'][0] - regist[2]['p2'][0]) / self.regist_sh[1]) * self.test_sh[1] + (regist_h / 2 * self.test_sh[0]),
                 (test[1][3] / self.test_sh[0] - regist_h / 4) * self.test_sh[0]],

                [(test[1][4] / self.test_sh[1] + (regist[1]['p3'][0] - regist[2]['p3'][0]) / self.regist_sh[1]) * self.test_sh[1] + (regist_h / 2 * self.test_sh[0]),
                 (test[1][5] / self.test_sh[0] + regist_h / 4) * self.test_sh[0]],

                [(test[1][6] / self.test_sh[1] + (regist[1]['p4'][0] - regist[2]['p4'][0]) / self.regist_sh[1]) * self.test_sh[1] - (regist_h / 2 * self.test_sh[0]),
                 (test[1][7] / self.test_sh[0] + regist_h / 4) * self.test_sh[0]]
            ]
